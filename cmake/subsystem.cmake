function(subsystem name)
    cmake_parse_arguments(S "" "" "CORE;INCLUDES" ${ARGN})
    ...
    # TODO split between i386 and x86_64
    ...
    target_include_directories(${name} PUBLIC ${S_INCLUDES})
    target_compile_definitions(${name} PRIVATE ${S_DEFINES})
    target_link_libraries(horizon.kernel PRIVATE ${name})
endfunction()
